...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2024 at 07:18 AM
...
(5003, 503, 'Penthouse', 5000.00, 'Booked'),
...
(2026, 1005, 5003, 'jojwdfgqnkfn nfwqifnqin', 95605630963, '2024-05-30 00:00:00', '2024-06-19', 95000, 'Active');
...
--
ALTER TABLE `tbl_transaction`
  MODIFY `transID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2027;
